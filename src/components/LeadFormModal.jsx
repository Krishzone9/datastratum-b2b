...
export default function LeadFormModal({ isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send form submission to datastratum.business@gmail.com using FormSubmit endpoint
        ...
        {submitted ? (
          <div className="modal-success">
            ...
            <p>
              ...
              <strong style={{ color: 'var(--color-accent)' }}>datastratum.business@gmail.com</strong>.
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="+91 89832 88354 (Enter with Country Code)"
              ...
              <p className="form-note">
                Directly sent to datastratum.business@gmail.com. We respect your privacy.
              </p>
            </form>
          </>
        )}
